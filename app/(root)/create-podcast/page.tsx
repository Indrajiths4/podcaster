...
const createPodcast = () => {
  ...
  return (
    <section className="mt-10 flex flex-col">
      <h1 className='text-20 text-white-1 font-bold'>Create Podcasts</h1>
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="mt-12 flex w-full flex-col">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col gap-2.5">
              ...
              <FormControl>
                <Input className="input-class focus-visible:ring-orange-1" placeholder="Podcastr" {...field} />
              </FormControl>
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <Select onValueChange={(value) => setVoiceType(value)}>
            <SelectTrigger className={cn('text-16 text-gray-1 border-none bg-black-1 w-full')}>
        ...
        <div className="flex flex-col pt-10">
          ...
          <div className="mt-10 w-full">
            <Button type="submit" className="text-16 text-white-1 w-full bg-orange-1 py-4 font-extrabold transition-all duration-500 hover:bg-black-1">
              {
                isSubmitting ? 
                ( <>
                  Submitting
